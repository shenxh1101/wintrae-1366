...
exports.createTestMp4 = createTestMp4;
exports.createTestMov = createTestMov;
...
function createMvhd(duration = 1000) {
...
function createTkhd(trackId, width, height, duration = 1000) {
...
function createMdhd(duration = 1000) {
...
function createTestMov(filePath, width, height) {
    const ftyp = createFtyp();
    const moov = createMoov(width, height);
    const mdat = createMdat();
    const fileData = Buffer.concat([ftyp, moov, mdat]);
